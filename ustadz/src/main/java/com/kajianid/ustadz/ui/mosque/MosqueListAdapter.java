...
import com.kajianid.ustadz.databinding.ItemMosqueListBinding;
...
public class MosqueListAdapter extends RecyclerView.Adapter<MosqueListAdapter.MosqueChooserViewHolder> {
    ...
    @NonNull
    @Override
    public MosqueListAdapter.MosqueChooserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MosqueListAdapter.MosqueChooserViewHolder holder, int position) {
        try {
